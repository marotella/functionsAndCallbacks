...
// CODE HERE
const multiply = (num1, num2, callit) => {
    callit((num1*num2))
}
...
// CODE HERE 
const contains = ( arr, name, onTheList) =>{
...
const uniq = (arr, noCopies) => {
    const noDuplicates = []
    for( const idx of arr){
        if(!noDuplicates.includes(idx)){
            noDuplicates.push(idx)
        }}
        noCopies(noDuplicates)
    }
